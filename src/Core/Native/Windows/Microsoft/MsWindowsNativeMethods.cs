...
namespace WatiN.Core.Native.Windows.Microsoft
{
    ...
    internal static class MsWindowsNativeMethods
    {
        ...
        internal static extern uint GetRoleText(uint dwRole, [Out] StringBuilder lpszRole, uint cchRoleMax);
        ...
        [DllImport("oleacc.dll")]
        internal static extern int AccessibleChildren(IAccessible paccContainer, int iChildStart, int cChildren, [Out] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] object[] rgvarChildren, ref int pcObtained);

...
namespace WatiN.Core.Native.Windows.Linux
{
    ...
    internal struct XClientMessageEvent
    {
        ...
        {
            [FieldOffset(0)] internal ByteMessage b;
            [FieldOffset(0)] internal ShortMessage s;
            [FieldOffset(0)] internal LongMessage l;
        }
    ...
    internal static class X11WindowsNativeMethods
    {
        ...
        private static XErrorHandler _originalEventHandler;
        ...
        internal static bool IsWindowValid(IntPtr window)
        {
            ...
            _originalEventHandler = XSetErrorHandler(handler);
            ...
            XSetErrorHandler(_originalEventHandler);
        ...
        {
            if (errorEvent.error_code != XErrorCode.BadWindow && _originalEventHandler != null)
            {
                _originalEventHandler(display, ref errorEvent);
            }
            return 0;
        }

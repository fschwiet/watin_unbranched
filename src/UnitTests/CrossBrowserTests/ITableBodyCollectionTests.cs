...
{
    /// <summary>
    /// Tests the behaviour of the <see cref="ITableBodyCollection"/> interface.
    /// </summary>
    public class ITableBodyCollectionTests : WatiNCrossBrowserTest
    {
        #region Public instance test methods

        /// <summary>
        /// Tests the behaviour of the <see cref="ITableBodyCollection.Item"/>.
        /// </summary>
        [Test]
        public void Index()
        {
        ...
        private static void IndexTest(IBrowser browser)
        {
            ...
            ITableBody tableBody = tableBodies[1];
            Assert.IsTrue(tableBody.Exists);
            Assert.AreEqual("tbody2", tableBody.Id);
        }

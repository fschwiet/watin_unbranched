...
namespace WatiN.Core.UnitTests.CrossBrowserTests
{
    ...
    public class ICheckBoxCollectionTests : CrossBrowserTest
    {
        ...
        /// <summary>
        /// Tests the behaviour of the <see cref="ICheckBoxCollection.Item"/>.
        /// </summary>
        [Test]
        public void Index()
        {
        ...
        /// <summary>
        /// Tests the behaviour of the <see cref="ICheckBoxCollection.Filter"/>
        /// </summary>
        [Test]
        public void Filter()
        {
        ...
        private static void FilterTest(IBrowser browser)
        {
            ...
            Assert.AreEqual(5, checkBoxes.Length);
            checkBoxes = checkBoxes.Filter(Find.ByValue(new Regex("^Effe")));
            Assert.AreEqual(5, checkBoxes.Length, GetErrorMessage("Incorrect no. of checkboxes returned from Filter method.", browser));
        }
        ...
        private static void IndexTest(IBrowser browser)
        {
            browser.GoTo(MainURI);
            ICheckBoxCollection checkBoxes = browser.CheckBoxes;
            ICheckBox checkBox = checkBoxes[2];
            Assert.IsTrue(checkBox.Exists);
            Assert.AreEqual("Checkbox2", checkBox.Id);
        }
